...
actor CameraPermissions {
    nonisolated(unsafe) static let shared = CameraPermissions()
    ...
    func requestAllPermissions() async -> (camera: Bool, microphone: Bool, photos: Bool) {
        ...
        return await (camera, microphone, photos)
    }
}
